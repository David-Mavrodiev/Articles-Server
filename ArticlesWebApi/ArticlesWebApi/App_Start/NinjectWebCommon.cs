[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(ArticlesWebApi.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(ArticlesWebApi.App_Start.NinjectWebCommon), "Stop")]
...
namespace ArticlesWebApi.App_Start
{
    ...
    using ArticlesWebApi.Data.Repository;
    using ArticlesWebApi.Services.Contracts;
    using ArticlesWebApi.Services;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IArticlesDbContext>().To<ArticlesDbContext>();
